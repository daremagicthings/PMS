        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-white">Автомашин</h1>
                </div>
                <button
            ...
            <div className="relative mb-6 max-w-md">
                ...
                <input
                    className="w-full bg-slate-800/60 text-white pl-10 pr-4 py-2.5 rounded-xl border border-slate-700/50 focus:border-blue-500 focus:outline-none text-sm"
                            ...
                            {vehicles.map((v) => (
                                <tr key={v.id} className="border-b border-slate-700/30 hover:bg-slate-700/20 transition-colors">
                                    <td className="px-5 py-3.5">
                                        <span className="bg-blue-500/15 text-blue-300 font-mono font-bold px-3 py-1 rounded-lg text-sm">
                                            {v.licensePlate}
                                        </span>
                                    </td>
                                    <td className="px-5 py-3.5 text-white">{v.makeModel}</td>
                                    ...
                                    <td className="px-5 py-3.5 text-right flex gap-2 justify-end">
                                        ...
                                        <button
                                            ...
                                            className="text-slate-400 hover:text-red-400 transition-colors p-1.5 rounded-lg hover:bg-slate-700/50 cursor-pointer"
                                            title="Устгах"
                                        >
                                            <Trash2 size={16} />
                                        </button>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md p-6 border border-slate-700/50">
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Улсын дугаар *</label>
                                <input
                                    className="w-full bg-slate-700/60 text-white px-3 py-2 rounded-lg border border-slate-600/50 focus:border-blue-500 focus:outline-none text-sm font-mono uppercase"
                            ...
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Марк / Загвар *</label>
                                <input
                            ...
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Орон сууц *</label>
                                <select
                                    className="w-full bg-slate-700/60 text-white px-3 py-2 rounded-lg border border-slate-600/50 focus:border-blue-500 focus:outline-none text-sm"
